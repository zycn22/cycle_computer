...
#### Buttons Interface
Buttons interface contains 3 addressable registers which are Button[0] (nMode), Button[1] (nTrip) and together_button.
...
Sensors Interface contains 4 addressable registers which are Sensor[0], Sensor[1], fork_cnt and crank_cnt.
